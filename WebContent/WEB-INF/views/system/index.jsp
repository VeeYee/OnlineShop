...
<body class="easyui-layout">
	<!-- 加载中...的样式 -->
	<div id="loading" style="position:absolute;z-index:1000;top:0px;left:0px;width:100%;height:100%;background:#FFFFFF;text-align:center;padding-top:15%">
		<img src="../resources/admin/easyui/images/loading.gif" width="400px">
    ...
    <div class="wu-main" data-options="region:'center'">
        <div id="wu-tabs" class="easyui-tabs" data-options="border:false,fit:true">  
        	<!-- 首页发送welcome请求，根据控制器，会跳转到welcome.jsp欢迎页面 -->
	...
	<div class="wu-footer" data-options="region:'south',border:true,split:true">
    	&copy; 2020 Yee All Rights Reserved
    </div>
