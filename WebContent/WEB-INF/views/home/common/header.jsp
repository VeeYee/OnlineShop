	...
	<div class="shop_hd">
		...
		<div class="shop_hd_topNav">
			<div class="shop_hd_topNav_all">
				...
				<div class="shop_hd_topNav_all_left">
					<p>您好，欢迎来到<b><a href="/OnlineShop">小北商城</a></b>
						<!-- 未登录时显示登录、注册；已登录时显示用户名 -->
					...
					<ul class="topNav_quick_menu">
						...
						<li>
							<div class="topNav_menu">
								<a href="javascript:void(0)" class="topNavHover">我的商城<i></i></a>
								<div class="topNav_menu_bd" style="display:none;" >
						            <ul>
						              <li><a title="个人主页" target="_top" href="../user/info">个人主页</a></li>
						            </ul>
						        </div>
							</div>
						</li>
						<li>
							<div class="topNav_menu">
								<a href="javascript:void(0)" class="topNavHover">我的收藏<i></i></a>
								<div class="topNav_menu_bd" style="display:none;">
						            <ul>
						...
						<li>
							<div class="topNav_menu">
								<a href="javascript:void(0)" class="topNavHover">我的购物车<i></i></a>
								<div class="topNav_menu_bd" style="display:none;">
						            <ul>
						              <li><a title="查看购物车" target="_top" href="../cart/list">查看购物车</a></li>
						            </ul>
						        </div>
							</div>
						</li>
						<li>
							<div class="topNav_menu">
								<a href="javascript:void(0)" class="topNavHover">我的订单<i></i></a>
								<div class="topNav_menu_bd" style="display:none;">
						            <ul>
						              <li><a title="查看订单" target="_top" href="../order/list">查看订单</a></li>
						            </ul>
						        </div>
							</div>
						</li>
		...
		<div class="shop_hd_header">
			<div class="shop_hd_header_logo"><h1 class="logo">
				<a href="/OnlineShop"><img src="../resources/home/images/logo.png" alt="Shop" /></a>
				<span>小北</span></h1>
			</div>
			    ...
			    <div class="search_form">
			    	...
			    	<form method="post" action="../product/search">
			    		<div class="search_formstyle">
			    			<!-- 表单提交将search_content参数带过去 -->
			    			<input type="text" class="search_form_text" name="search_content" placeholder="搜索商品" value="${search_content }"/>
		...
		<div class="shop_hd_menu">
			<div class="shop_hd_menu_all_category ${allCategoryClass }" id="${allCategoryId }"><!-- 首页去掉 id="shop_hd_menu_all_category" 加上clsss shop_hd_menu_hover -->
				<div class="shop_hd_menu_all_category_title"><h2 title="所有商品分类"><a href="/OnlineShop">所有商品分类</a></h2><i></i></div>
						...
						<c:forEach items="${productCategoryList }" var="productCategory">
							...
							<li id="cat_${productCategory.id }" class="">
								...
								<div id="cat_${productCategory.id }_menu" class="cat_menu clearfix" style="">
									...
									<dl class="clearfix">
										<dt><a href="../product/product_category_list?cid=${child.id }" >${child.text }</a></dt>
										<dd>
