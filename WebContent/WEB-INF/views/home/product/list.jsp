	...
	<div class="shop_bd_list_right clearfix">
		...
		<div class="sort-bar">
			<div class="bar-l"> 
	            <!-- 不同的排序方式 -->
	            <ul class="array">
                	<li class="selected"><a title="默认排序"  class="nobg" href="../product/product_category_list?cid=${cid }&page=${page}">默认</a></li>
              		<li><a title="按销量从高到低排序"  href="../product/product_category_list?cid=${cid }&orderBy=sellNum&priceMin=${priceMin}&priceMax=${priceMax}&page=${page}">销量</a></li>
              		<li><a title="按人气从高到低排序"  href="../product/product_category_list?cid=${cid }&orderBy=viewNum&priceMin=${priceMin}&priceMax=${priceMax}&page=${page}">人气</a></li>
             		<li><a title="按价格从高到低排序"  href="../product/product_category_list?cid=${cid }&orderBy=price&priceMin=${priceMin}&priceMax=${priceMax}&page=${page}">价格</a></li>
	            </ul>
	            <!-- 按价格区间搜索 -->
		...
		<!-- 显示属于本分类的所有商品，按条件筛选出来的商品也在此显示（无筛选条件就是显示全部商品） -->
