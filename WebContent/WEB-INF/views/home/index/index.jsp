       ...
       <div class="shop_bd_home_block_center" style="width:998px;">
           ...
           <div class="tabs-panel" style="width:998px;">
               ...
               <c:forEach items="${lastProductList }" var="lastProduct">
                   <li>
                       <dl>
                           <dt><a href="../product/detail?id=${lastProduct.id }"><img src="${lastProduct.imageUrl }" /></a></dt>
                           <dd><a href="">${lastProduct.name }</a></dd>
                           <dd>商城价：<em>${lastProduct.price }</em>元</dd>
                       </dl>
                   </li>
                </c:forEach>
                </ul>
       ...
       <div class="shop_bd_home_block_center" style="width:998px;">
           ...
           <div class="tabs-panel" style="width:998px;">
               ...
               <c:forEach items="${sellProductList }" var="sellProduct">
                   <li>
                       <dl>
                           <dt><a href="../product/detail?id=${sellProduct.id }"><img src="${sellProduct.imageUrl }" /></a></dt>
                           <dd><a href="">${sellProduct.name }</a></dd>
                           <dd>商城价：<em>${sellProduct.price }</em>元</dd>
                       </dl>
                   </li>
				</c:forEach>
				</ul>
